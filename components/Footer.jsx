        ...
        <div className="flex flex-col items-center justify-between gap-6 py-10 sm:flex-row">
          ...
          <div className="flex flex-col items-center gap-3 sm:items-start">
            <Link href="/" className="group inline-flex items-center gap-2.5">
              ...
              <span className="text-lg font-bold text-gray-900">Trakio</span>
            </Link>
            <p className="max-w-xs text-center text-sm leading-relaxed text-gray-500 sm:text-left">
          ...
          <div className="flex items-center gap-6">
            ...
            <a
              ...
              className="flex h-9 w-9 items-center justify-center rounded-xl border border-gray-200 text-gray-400 shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:border-brand-light hover:bg-brand-light hover:text-brand hover:shadow-md"
              aria-label="Email"
            >
